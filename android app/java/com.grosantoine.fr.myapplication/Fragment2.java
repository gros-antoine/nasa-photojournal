...
public class Fragment2 extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        getJSON("http://ip/req_fd.php?date=" + lastDate);
    }
    ...
    private AdapterView.OnItemClickListener clickListener = new AdapterView.OnItemClickListener() {
        ...
        public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
            ...
            Intent intent = new Intent(getContext(), Desc2.class);
    ...
    // Le listener de longs clicks sur les images
        ...
        public void onScroll(AbsListView absListView, int firstVisibleItem, int visibleItemCount, int totalItemCount) {
            ...
            if(firstVisibleItem+visibleItemCount == totalItemCount && totalItemCount != 0) {
                ...
                if(!flag_loading) {
                    ...
                    populateList("http://ip/req_fd.php?date=" + lastDate);
                }
            }
        }
    };
        ...
        class DeleteImage extends AsyncTask<Void, Void, Void> {
            ...
            protected Void doInBackground(Void... voids) {
                ...
                try {
                    ...
                    String url = "http://ip/del_d2.php?id=" + id;

                    // On charge l'url pour supprimer les données
                    URL uri = new URL(url);
                    Scanner scanner = new Scanner(uri.openStream());

                    // Création de l'url pour récupérer les nouvelles dates
                    URL url_date = new URL("http://ip/req_date.php");
                    HttpURLConnection con = (HttpURLConnection) url_date.openConnection();
                    ...
                    for(int i = 0; i < jsonArray.length(); i++) {
                        ...
                        // Update de la nouvelle date dans l'ArrayList
                        int index = ids.indexOf(obj.getString("id"));
                        dates.set(index, obj.getString("date"));
                    }
